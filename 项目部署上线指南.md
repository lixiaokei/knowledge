...
```Shell
docker run -d -p 801:80 -v /root/nginx/logs/nginx1:/var/log/nginx --name nginx1 nginx:latest
docker run -d -p 802:80 -v /root/nginx/logs/nginx2:/var/log/nginx --name nginx2 nginx:latest
docker run -d -p 803:80 -v /root/nginx/logs/nginx3:/var/log/nginx --name nginx3 nginx:latest
```
