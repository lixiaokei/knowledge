...
![](./res/django_massive_cluster.png)
...
问题1：关系型数据库表的设计应该注意哪些问题？如何通过表来创建模型类？如何通过模型类来创建表？（范式理论/反向工程/正向工程）
...
问题2：如何实现异步任务和定时任务？（Celery / django-crontab / schedule）
...
1. ab - Apache Benchmark / webbench
...
4. jmeter - 请查看[《使用JMeter进行性能测试》](https://www.ibm.com/developerworks/cn/java/l-jmeter/index.html)。
